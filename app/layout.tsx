...
export const metadata: Metadata = {
  ...
  description: 'Aenfinite® is a professional digital innovation agency in Sydney specializing in custom web design, brand identity, UI/UX design, digital marketing, e-commerce development, and comprehensive digital transformation solutions.',
  icons: {
    icon: [
