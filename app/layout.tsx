...
export const metadata: Metadata = {
  metadataBase: new URL('https://aenfinite.sydney'),
  title: {
    default: 'Aenfinite® | Professional Digital Innovation Agency',
    template: '%s | Aenfinite®',
  },
  description: 'Aenfinite® is a professional digital innovation agency in Sydney delivering AI solutions & automation, custom software and app development, SEO & digital marketing, e-commerce, branding, UI/UX design, and digital transformation solutions.',
  icons: {
    icon: [
      { url: '/wp-content/themes/aenfinite.sydney/favicon/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
      { url: '/wp-content/themes/aenfinite.sydney/favicon/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
    ],
    apple: [
      { url: '/wp-content/themes/aenfinite.sydney/favicon/apple-touch-icon.png', sizes: '180x180' },
    ],
    shortcut: '/wp-content/themes/aenfinite.sydney/favicon/favicon.ico',
  },
  manifest: '/wp-content/themes/aenfinite.sydney/favicon/site.webmanifest',
  openGraph: {
    siteName: 'Aenfinite',
    images: [{
  ...
  return (
    <html lang="en-AU">
      <head>
        ...
        <link
          rel="preload"
          href="/wp-content/themes/aenfinite.sydney/static/css/mainf1a7.css?v=20250731-2020"
          as="style"
        />
        <link
          href="/wp-content/themes/aenfinite.sydney/static/css/mainf1a7.css?v=20250731-2020"
        ...
        <link
          rel="preload"
          href="/wp-content/themes/aenfinite.sydney/stylef1a7.css?v=20250731-2020"
          as="style"
        />
        <link
          href="/wp-content/themes/aenfinite.sydney/stylef1a7.css?v=20250731-2020"
      ...
      <body>
        ...
        <Script
          src="/wp-content/themes/aenfinite.sydney/static/js/jquery.min.js"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.sydney/static/js/slick.min.js"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.sydney/static/js/gsap.min.js"
          strategy="afterInteractive"
        />
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-SYD0000001"
          strategy="lazyOnload"
        />
        ...
        {/* Page functionality */}
        <Script
          src="/wp-content/themes/aenfinite.sydney/static/js/demo5163.js?v=20241204-0018"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.sydney/static/js/aos.js"
          strategy="afterInteractive"
        />
        ...
        <Script id="wpcf7-config" strategy="lazyOnload">
          {`var wpcf7 = {"api":{"root":"https://aenfinite.sydney/wp-json/","namespace":"contact-form-7/v1"},"cached":1};`}
        </Script>
